var yt=Object.defineProperty;var Fe=e=>{throw TypeError(e)};var wt=(e,t,r)=>t in e?yt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var u=(e,t,r)=>wt(e,typeof t!="symbol"?t+"":t,r),Te=(e,t,r)=>t.has(e)||Fe("Cannot "+r);var o=(e,t,r)=>(Te(e,t,"read from private field"),r?r.call(e):t.get(e)),g=(e,t,r)=>t.has(e)?Fe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),p=(e,t,r,n)=>(Te(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),v=(e,t,r)=>(Te(e,t,"access private method"),r);var _e=(e,t,r,n)=>({set _(a){p(e,t,a,r)},get _(){return o(e,t,n)}});var He=(e,t,r)=>(n,a)=>{let i=-1;return s(0);async function s(l){if(l<=i)throw new Error("next() called multiple times");i=l;let c,d=!1,f;if(e[l]?(f=e[l][0][0],n.req.routeIndex=l):f=l===e.length&&a||void 0,f)try{c=await f(n,()=>s(l+1))}catch(h){if(h instanceof Error&&t)n.error=h,c=await t(h,n),d=!0;else throw h}else n.finalized===!1&&r&&(c=await r(n));return c&&(n.finalized===!1||d)&&(n.res=c),n}},At=Symbol(),Et=async(e,t=Object.create(null))=>{const{all:r=!1,dot:n=!1}=t,i=(e instanceof at?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Ot(e,{all:r,dot:n}):{}};async function Ot(e,t){const r=await e.formData();return r?Rt(r,t):{}}function Rt(e,t){const r=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?Ct(r,a,n):r[a]=n}),t.dot&&Object.entries(r).forEach(([n,a])=>{n.includes(".")&&(St(r,n,a),delete r[n])}),r}var Ct=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},St=(e,t,r)=>{let n=e;const a=t.split(".");a.forEach((i,s)=>{s===a.length-1?n[i]=r:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},Ze=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},kt=e=>{const{groups:t,path:r}=jt(e),n=Ze(r);return Tt(n,t)},jt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,n)=>{const a=`@${n}`;return t.push([a,r]),a}),{groups:t,path:e}},Tt=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[n]=t[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[r][1]);break}}return e},ye={},Dt=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const n=`${e}#${t}`;return ye[n]||(r[2]?ye[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:ye[n]=[e,r[1],!0]),ye[n]}return null},Ne=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Pt=e=>Ne(e,decodeURI),et=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let n=r;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),s=t.slice(r,i===-1?void 0:i);return Pt(s.includes("%25")?s.replace(/%25/g,"%2525"):s)}else if(a===63)break}return t.slice(r,n)},It=e=>{const t=et(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},te=(e,t,...r)=>(r.length&&(t=te(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),tt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&n===""?r.push("/"):r.push(n);const i=a.replace("?","");n+="/"+i,r.push(n)}else n+="/"+a}),r.filter((a,i,s)=>s.indexOf(a)===i)},De=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ne(e,nt):e):e,rt=(e,t,r)=>{let n;if(!r&&t&&!/[%+]/.test(t)){let s=e.indexOf("?",8);if(s===-1)return;for(e.startsWith(t,s+1)||(s=e.indexOf(`&${t}`,s+1));s!==-1;){const l=e.charCodeAt(s+t.length+1);if(l===61){const c=s+t.length+2,d=e.indexOf("&",c);return De(e.slice(c,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";s=e.indexOf(`&${t}`,s+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const s=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>s&&s!==-1&&(l=-1);let c=e.slice(i+1,l===-1?s===-1?void 0:s:l);if(n&&(c=De(c)),i=s,c==="")continue;let d;l===-1?d="":(d=e.slice(l+1,s===-1?void 0:s),n&&(d=De(d))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return t?a[t]:a},Lt=rt,Nt=(e,t)=>rt(e,t,!0),nt=decodeURIComponent,Me=e=>Ne(e,nt),ae,k,_,it,st,Ie,M,Ue,at=(Ue=class{constructor(e,t="/",r=[[]]){g(this,_);u(this,"raw");g(this,ae);g(this,k);u(this,"routeIndex",0);u(this,"path");u(this,"bodyCache",{});g(this,M,e=>{const{bodyCache:t,raw:r}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,p(this,k,r),p(this,ae,{})}param(e){return e?v(this,_,it).call(this,e):v(this,_,st).call(this)}query(e){return Lt(this.url,e)}queries(e){return Nt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,n)=>{t[n]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Et(this,e))}json(){return o(this,M).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,M).call(this,"text")}arrayBuffer(){return o(this,M).call(this,"arrayBuffer")}blob(){return o(this,M).call(this,"blob")}formData(){return o(this,M).call(this,"formData")}addValidatedData(e,t){o(this,ae)[e]=t}valid(e){return o(this,ae)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[At](){return o(this,k)}get matchedRoutes(){return o(this,k)[0].map(([[,e]])=>e)}get routePath(){return o(this,k)[0].map(([[,e]])=>e)[this.routeIndex].path}},ae=new WeakMap,k=new WeakMap,_=new WeakSet,it=function(e){const t=o(this,k)[0][this.routeIndex][1][e],r=v(this,_,Ie).call(this,t);return r&&/\%/.test(r)?Me(r):r},st=function(){const e={},t=Object.keys(o(this,k)[0][this.routeIndex][1]);for(const r of t){const n=v(this,_,Ie).call(this,o(this,k)[0][this.routeIndex][1][r]);n!==void 0&&(e[r]=/\%/.test(n)?Me(n):n)}return e},Ie=function(e){return o(this,k)[1]?o(this,k)[1][e]:e},M=new WeakMap,Ue),zt={Stringify:1},ot=async(e,t,r,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(c=>ot(c,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},Ft="text/plain; charset=UTF-8",Pe=(e,t)=>({"Content-Type":e,...t}),ue,me,L,ie,N,C,ge,se,oe,K,ve,xe,$,re,qe,_t=(qe=class{constructor(e,t){g(this,$);g(this,ue);g(this,me);u(this,"env",{});g(this,L);u(this,"finalized",!1);u(this,"error");g(this,ie);g(this,N);g(this,C);g(this,ge);g(this,se);g(this,oe);g(this,K);g(this,ve);g(this,xe);u(this,"render",(...e)=>(o(this,se)??p(this,se,t=>this.html(t)),o(this,se).call(this,...e)));u(this,"setLayout",e=>p(this,ge,e));u(this,"getLayout",()=>o(this,ge));u(this,"setRenderer",e=>{p(this,se,e)});u(this,"header",(e,t,r)=>{this.finalized&&p(this,C,new Response(o(this,C).body,o(this,C)));const n=o(this,C)?o(this,C).headers:o(this,K)??p(this,K,new Headers);t===void 0?n.delete(e):r!=null&&r.append?n.append(e,t):n.set(e,t)});u(this,"status",e=>{p(this,ie,e)});u(this,"set",(e,t)=>{o(this,L)??p(this,L,new Map),o(this,L).set(e,t)});u(this,"get",e=>o(this,L)?o(this,L).get(e):void 0);u(this,"newResponse",(...e)=>v(this,$,re).call(this,...e));u(this,"body",(e,t,r)=>v(this,$,re).call(this,e,t,r));u(this,"text",(e,t,r)=>!o(this,K)&&!o(this,ie)&&!t&&!r&&!this.finalized?new Response(e):v(this,$,re).call(this,e,t,Pe(Ft,r)));u(this,"json",(e,t,r)=>v(this,$,re).call(this,JSON.stringify(e),t,Pe("application/json",r)));u(this,"html",(e,t,r)=>{const n=a=>v(this,$,re).call(this,a,t,Pe("text/html; charset=UTF-8",r));return typeof e=="object"?ot(e,zt.Stringify,!1,{}).then(n):n(e)});u(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});u(this,"notFound",()=>(o(this,oe)??p(this,oe,()=>new Response),o(this,oe).call(this,this)));p(this,ue,e),t&&(p(this,N,t.executionCtx),this.env=t.env,p(this,oe,t.notFoundHandler),p(this,xe,t.path),p(this,ve,t.matchResult))}get req(){return o(this,me)??p(this,me,new at(o(this,ue),o(this,xe),o(this,ve))),o(this,me)}get event(){if(o(this,N)&&"respondWith"in o(this,N))return o(this,N);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,N))return o(this,N);throw Error("This context has no ExecutionContext")}get res(){return o(this,C)||p(this,C,new Response(null,{headers:o(this,K)??p(this,K,new Headers)}))}set res(e){if(o(this,C)&&e){e=new Response(e.body,e);for(const[t,r]of o(this,C).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=o(this,C).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,r)}p(this,C,e),this.finalized=!0}get var(){return o(this,L)?Object.fromEntries(o(this,L)):{}}},ue=new WeakMap,me=new WeakMap,L=new WeakMap,ie=new WeakMap,N=new WeakMap,C=new WeakMap,ge=new WeakMap,se=new WeakMap,oe=new WeakMap,K=new WeakMap,ve=new WeakMap,xe=new WeakMap,$=new WeakSet,re=function(e,t,r){const n=o(this,C)?new Headers(o(this,C).headers):o(this,K)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,l]of i)s.toLowerCase()==="set-cookie"?n.append(s,l):n.set(s,l)}if(r)for(const[i,s]of Object.entries(r))if(typeof s=="string")n.set(i,s);else{n.delete(i);for(const l of s)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ie);return new Response(e,{status:a,headers:n})},qe),w="ALL",Ht="all",Mt=["get","post","put","delete","options","patch"],ct="Can not add a route since the matcher is already built.",lt=class extends Error{},$t="__COMPOSED_HANDLER",Yt=e=>e.text("404 Not Found",404),$e=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},j,A,ft,T,W,we,Ae,We,dt=(We=class{constructor(t={}){g(this,A);u(this,"get");u(this,"post");u(this,"put");u(this,"delete");u(this,"options");u(this,"patch");u(this,"all");u(this,"on");u(this,"use");u(this,"router");u(this,"getPath");u(this,"_basePath","/");g(this,j,"/");u(this,"routes",[]);g(this,T,Yt);u(this,"errorHandler",$e);u(this,"onError",t=>(this.errorHandler=t,this));u(this,"notFound",t=>(p(this,T,t),this));u(this,"fetch",(t,...r)=>v(this,A,Ae).call(this,t,r[1],r[0],t.method));u(this,"request",(t,r,n,a)=>t instanceof Request?this.fetch(r?new Request(t,r):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${te("/",t)}`,r),n,a)));u(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(v(this,A,Ae).call(this,t.request,t,void 0,t.request.method))})});[...Mt,Ht].forEach(i=>{this[i]=(s,...l)=>(typeof s=="string"?p(this,j,s):v(this,A,W).call(this,i,o(this,j),s),l.forEach(c=>{v(this,A,W).call(this,i,o(this,j),c)}),this)}),this.on=(i,s,...l)=>{for(const c of[s].flat()){p(this,j,c);for(const d of[i].flat())l.map(f=>{v(this,A,W).call(this,d.toUpperCase(),o(this,j),f)})}return this},this.use=(i,...s)=>(typeof i=="string"?p(this,j,i):(p(this,j,"*"),s.unshift(i)),s.forEach(l=>{v(this,A,W).call(this,w,o(this,j),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??et:It}route(t,r){const n=this.basePath(t);return r.routes.map(a=>{var s;let i;r.errorHandler===$e?i=a.handler:(i=async(l,c)=>(await He([],r.errorHandler)(l,()=>a.handler(l,c))).res,i[$t]=a.handler),v(s=n,A,W).call(s,a.method,a.path,i)}),this}basePath(t){const r=v(this,A,ft).call(this);return r._basePath=te(this._basePath,t),r}mount(t,r,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=c=>c:a=n.replaceRequest));const s=i?c=>{const d=i(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=te(this._basePath,t),d=c==="/"?0:c.length;return f=>{const h=new URL(f.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,f)}})());const l=async(c,d)=>{const f=await r(a(c.req.raw),...s(c));if(f)return f;await d()};return v(this,A,W).call(this,w,te(t,"*"),l),this}},j=new WeakMap,A=new WeakSet,ft=function(){const t=new dt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,p(t,T,o(this,T)),t.routes=this.routes,t},T=new WeakMap,W=function(t,r,n){t=t.toUpperCase(),r=te(this._basePath,r);const a={basePath:this._basePath,path:r,method:t,handler:n};this.router.add(t,r,[n,a]),this.routes.push(a)},we=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Ae=function(t,r,n,a){if(a==="HEAD")return(async()=>new Response(null,await v(this,A,Ae).call(this,t,r,n,"GET")))();const i=this.getPath(t,{env:n}),s=this.router.match(a,i),l=new _t(t,{path:i,matchResult:s,env:n,executionCtx:r,notFoundHandler:o(this,T)});if(s[0].length===1){let d;try{d=s[0][0][0][0](l,async()=>{l.res=await o(this,T).call(this,l)})}catch(f){return v(this,A,we).call(this,f,l)}return d instanceof Promise?d.then(f=>f||(l.finalized?l.res:o(this,T).call(this,l))).catch(f=>v(this,A,we).call(this,f,l)):d??o(this,T).call(this,l)}const c=He(s[0],this.errorHandler,o(this,T));return(async()=>{try{const d=await c(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return v(this,A,we).call(this,d,l)}})()},We),pt=[];function Bt(e,t){const r=this.buildAllMatchers(),n=(a,i)=>{const s=r[a]||r[w],l=s[2][i];if(l)return l;const c=i.match(s[0]);if(!c)return[[],pt];const d=c.indexOf("",1);return[s[1][d],c]};return this.match=n,n(e,t)}var Oe="[^/]+",pe=".*",he="(?:|/.*)",ne=Symbol(),Ut=new Set(".\\+*[^]$()");function qt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===pe||e===he?1:t===pe||t===he?-1:e===Oe?1:t===Oe?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var V,X,D,Ge,Le=(Ge=class{constructor(){g(this,V);g(this,X);g(this,D,Object.create(null))}insert(t,r,n,a,i){if(t.length===0){if(o(this,V)!==void 0)throw ne;if(i)return;p(this,V,r);return}const[s,...l]=t,c=s==="*"?l.length===0?["","",pe]:["","",Oe]:s==="/*"?["","",he]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const f=c[1];let h=c[2]||Oe;if(f&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw ne;if(d=o(this,D)[h],!d){if(Object.keys(o(this,D)).some(m=>m!==pe&&m!==he))throw ne;if(i)return;d=o(this,D)[h]=new Le,f!==""&&p(d,X,a.varIndex++)}!i&&f!==""&&n.push([f,o(d,X)])}else if(d=o(this,D)[s],!d){if(Object.keys(o(this,D)).some(f=>f.length>1&&f!==pe&&f!==he))throw ne;if(i)return;d=o(this,D)[s]=new Le}d.insert(l,r,n,a,i)}buildRegExpStr(){const r=Object.keys(o(this,D)).sort(qt).map(n=>{const a=o(this,D)[n];return(typeof o(a,X)=="number"?`(${n})@${o(a,X)}`:Ut.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof o(this,V)=="number"&&r.unshift(`#${o(this,V)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},V=new WeakMap,X=new WeakMap,D=new WeakMap,Ge),Re,be,Ke,Wt=(Ke=class{constructor(){g(this,Re,{varIndex:0});g(this,be,new Le)}insert(e,t,r){const n=[],a=[];for(let s=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const d=`@\\${s}`;return a[s]=[d,c],s++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=a.length-1;s>=0;s--){const[l]=a[s];for(let c=i.length-1;c>=0;c--)if(i[c].indexOf(l)!==-1){i[c]=i[c].replace(l,a[s][1]);break}}return o(this,be).insert(i,t,n,o(this,Re),r),n}buildRegExp(){let e=o(this,be).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,s)=>i!==void 0?(r[++t]=Number(i),"$()"):(s!==void 0&&(n[Number(s)]=++t),"")),[new RegExp(`^${e}`),r,n]}},Re=new WeakMap,be=new WeakMap,Ke),Gt=[/^$/,[],Object.create(null)],Ee=Object.create(null);function ht(e){return Ee[e]??(Ee[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Kt(){Ee=Object.create(null)}function Vt(e){var d;const t=new Wt,r=[];if(e.length===0)return Gt;const n=e.map(f=>[!/\*|\/:/.test(f[0]),...f]).sort(([f,h],[m,y])=>f?1:m?-1:h.length-y.length),a=Object.create(null);for(let f=0,h=-1,m=n.length;f<m;f++){const[y,S,x]=n[f];y?a[S]=[x.map(([R])=>[R,Object.create(null)]),pt]:h++;let b;try{b=t.insert(S,h,y)}catch(R){throw R===ne?new lt(S):R}y||(r[h]=x.map(([R,Z])=>{const le=Object.create(null);for(Z-=1;Z>=0;Z--){const[P,ke]=b[Z];le[P]=ke}return[R,le]}))}const[i,s,l]=t.buildRegExp();for(let f=0,h=r.length;f<h;f++)for(let m=0,y=r[f].length;m<y;m++){const S=(d=r[f][m])==null?void 0:d[1];if(!S)continue;const x=Object.keys(S);for(let b=0,R=x.length;b<R;b++)S[x[b]]=l[S[x[b]]]}const c=[];for(const f in s)c[f]=r[s[f]];return[i,c,a]}function ee(e,t){if(e){for(const r of Object.keys(e).sort((n,a)=>a.length-n.length))if(ht(r).test(t))return[...e[r]]}}var Y,B,Ce,ut,Ve,Xt=(Ve=class{constructor(){g(this,Ce);u(this,"name","RegExpRouter");g(this,Y);g(this,B);u(this,"match",Bt);p(this,Y,{[w]:Object.create(null)}),p(this,B,{[w]:Object.create(null)})}add(e,t,r){var l;const n=o(this,Y),a=o(this,B);if(!n||!a)throw new Error(ct);n[e]||[n,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[w]).forEach(d=>{c[e][d]=[...c[w][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=ht(t);e===w?Object.keys(n).forEach(d=>{var f;(f=n[d])[t]||(f[t]=ee(n[d],t)||ee(n[w],t)||[])}):(l=n[e])[t]||(l[t]=ee(n[e],t)||ee(n[w],t)||[]),Object.keys(n).forEach(d=>{(e===w||e===d)&&Object.keys(n[d]).forEach(f=>{c.test(f)&&n[d][f].push([r,i])})}),Object.keys(a).forEach(d=>{(e===w||e===d)&&Object.keys(a[d]).forEach(f=>c.test(f)&&a[d][f].push([r,i]))});return}const s=tt(t)||[t];for(let c=0,d=s.length;c<d;c++){const f=s[c];Object.keys(a).forEach(h=>{var m;(e===w||e===h)&&((m=a[h])[f]||(m[f]=[...ee(n[h],f)||ee(n[w],f)||[]]),a[h][f].push([r,i-d+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,B)).concat(Object.keys(o(this,Y))).forEach(t=>{e[t]||(e[t]=v(this,Ce,ut).call(this,t))}),p(this,Y,p(this,B,void 0)),Kt(),e}},Y=new WeakMap,B=new WeakMap,Ce=new WeakSet,ut=function(e){const t=[];let r=e===w;return[o(this,Y),o(this,B)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(r||(r=!0),t.push(...a)):e!==w&&t.push(...Object.keys(n[w]).map(i=>[i,n[w][i]]))}),r?Vt(t):null},Ve),U,z,Xe,Jt=(Xe=class{constructor(e){u(this,"name","SmartRouter");g(this,U,[]);g(this,z,[]);p(this,U,e.routers)}add(e,t,r){if(!o(this,z))throw new Error(ct);o(this,z).push([e,t,r])}match(e,t){if(!o(this,z))throw new Error("Fatal error");const r=o(this,U),n=o(this,z),a=r.length;let i=0,s;for(;i<a;i++){const l=r[i];try{for(let c=0,d=n.length;c<d;c++)l.add(...n[c]);s=l.match(e,t)}catch(c){if(c instanceof lt)continue;throw c}this.match=l.match.bind(l),p(this,U,[l]),p(this,z,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(o(this,z)||o(this,U).length!==1)throw new Error("No active router has been determined yet.");return o(this,U)[0]}},U=new WeakMap,z=new WeakMap,Xe),fe=Object.create(null),q,O,J,ce,E,F,G,Je,mt=(Je=class{constructor(e,t,r){g(this,F);g(this,q);g(this,O);g(this,J);g(this,ce,0);g(this,E,fe);if(p(this,O,r||Object.create(null)),p(this,q,[]),e&&t){const n=Object.create(null);n[e]={handler:t,possibleKeys:[],score:0},p(this,q,[n])}p(this,J,[])}insert(e,t,r){p(this,ce,++_e(this,ce)._);let n=this;const a=kt(t),i=[];for(let s=0,l=a.length;s<l;s++){const c=a[s],d=a[s+1],f=Dt(c,d),h=Array.isArray(f)?f[0]:c;if(h in o(n,O)){n=o(n,O)[h],f&&i.push(f[1]);continue}o(n,O)[h]=new mt,f&&(o(n,J).push(f),i.push(f[1])),n=o(n,O)[h]}return o(n,q).push({[e]:{handler:r,possibleKeys:i.filter((s,l,c)=>c.indexOf(s)===l),score:o(this,ce)}}),n}search(e,t){var l;const r=[];p(this,E,fe);let a=[this];const i=Ze(t),s=[];for(let c=0,d=i.length;c<d;c++){const f=i[c],h=c===d-1,m=[];for(let y=0,S=a.length;y<S;y++){const x=a[y],b=o(x,O)[f];b&&(p(b,E,o(x,E)),h?(o(b,O)["*"]&&r.push(...v(this,F,G).call(this,o(b,O)["*"],e,o(x,E))),r.push(...v(this,F,G).call(this,b,e,o(x,E)))):m.push(b));for(let R=0,Z=o(x,J).length;R<Z;R++){const le=o(x,J)[R],P=o(x,E)===fe?{}:{...o(x,E)};if(le==="*"){const H=o(x,O)["*"];H&&(r.push(...v(this,F,G).call(this,H,e,o(x,E))),p(H,E,P),m.push(H));continue}const[ke,ze,de]=le;if(!f&&!(de instanceof RegExp))continue;const I=o(x,O)[ke],bt=i.slice(c).join("/");if(de instanceof RegExp){const H=de.exec(bt);if(H){if(P[ze]=H[0],r.push(...v(this,F,G).call(this,I,e,o(x,E),P)),Object.keys(o(I,O)).length){p(I,E,P);const je=((l=H[0].match(/\//))==null?void 0:l.length)??0;(s[je]||(s[je]=[])).push(I)}continue}}(de===!0||de.test(f))&&(P[ze]=f,h?(r.push(...v(this,F,G).call(this,I,e,P,o(x,E))),o(I,O)["*"]&&r.push(...v(this,F,G).call(this,o(I,O)["*"],e,P,o(x,E)))):(p(I,E,P),m.push(I)))}}a=m.concat(s.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},q=new WeakMap,O=new WeakMap,J=new WeakMap,ce=new WeakMap,E=new WeakMap,F=new WeakSet,G=function(e,t,r,n){const a=[];for(let i=0,s=o(e,q).length;i<s;i++){const l=o(e,q)[i],c=l[t]||l[w],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),r!==fe||n&&n!==fe))for(let f=0,h=c.possibleKeys.length;f<h;f++){const m=c.possibleKeys[f],y=d[c.score];c.params[m]=n!=null&&n[m]&&!y?n[m]:r[m]??(n==null?void 0:n[m]),d[c.score]=!0}}return a},Je),Q,Qe,Qt=(Qe=class{constructor(){u(this,"name","TrieRouter");g(this,Q);p(this,Q,new mt)}add(e,t,r){const n=tt(t);if(n){for(let a=0,i=n.length;a<i;a++)o(this,Q).insert(e,n[a],r);return}o(this,Q).insert(e,t,r)}match(e,t){return o(this,Q).search(e,t)}},Q=new WeakMap,Qe),gt=class extends dt{constructor(e={}){super(e),this.router=e.router??new Jt({routers:[new Xt,new Qt]})}},Zt=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Ye=(e,t=tr)=>{const r=/\.([a-zA-Z0-9]+?)$/,n=e.match(r);if(!n)return;let a=t[n[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},er={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},tr=er,rr=(...e)=>{let t=e.filter(a=>a!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const r=t.split("/"),n=[];for(const a of r)a===".."&&n.length>0&&n.at(-1)!==".."?n.pop():a!=="."&&n.push(a);return n.join("/")||"."},vt={br:".br",zstd:".zst",gzip:".gz"},nr=Object.keys(vt),ar="index.html",ir=e=>{const t=e.root??"./",r=e.path,n=e.join??rr;return async(a,i)=>{var f,h,m,y;if(a.finalized)return i();let s;if(e.path)s=e.path;else try{if(s=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(s))throw new Error}catch{return await((f=e.onNotFound)==null?void 0:f.call(e,a.req.path,a)),i()}let l=n(t,!r&&e.rewriteRequestPath?e.rewriteRequestPath(s):s);e.isDir&&await e.isDir(l)&&(l=n(l,ar));const c=e.getContent;let d=await c(l,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const S=e.mimes&&Ye(l,e.mimes)||Ye(l);if(a.header("Content-Type",S||"application/octet-stream"),e.precompressed&&(!S||Zt.test(S))){const x=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(b=>b.trim()));for(const b of nr){if(!x.has(b))continue;const R=await c(l+vt[b],a);if(R){d=R,a.header("Content-Encoding",b),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,l,a)),a.body(d)}await((y=e.onNotFound)==null?void 0:y.call(e,l,a)),await i()}},sr=async(e,t)=>{let r;t&&t.manifest?typeof t.manifest=="string"?r=JSON.parse(t.manifest):r=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?r=JSON.parse(__STATIC_CONTENT_MANIFEST):r=__STATIC_CONTENT_MANIFEST;let n;t&&t.namespace?n=t.namespace:n=__STATIC_CONTENT;const a=r[e]||e;if(!a)return null;const i=await n.get(a,{type:"stream"});return i||null},or=e=>async function(r,n){return ir({...e,getContent:async i=>sr(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:r.env?r.env.__STATIC_CONTENT:void 0})})(r,n)},cr=e=>or(e),lr=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:s=>i===s?s:null:typeof i=="function"?i:s=>i.includes(s)?s:null)(r.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(r.allowMethods);return async function(s,l){var f;function c(h,m){s.res.headers.set(h,m)}const d=await n(s.req.header("origin")||"",s);if(d&&c("Access-Control-Allow-Origin",d),r.credentials&&c("Access-Control-Allow-Credentials","true"),(f=r.exposeHeaders)!=null&&f.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),s.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const h=await a(s.req.header("origin")||"",s);h.length&&c("Access-Control-Allow-Methods",h.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const y=s.req.header("Access-Control-Request-Headers");y&&(m=y.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),s.res.headers.append("Vary","Access-Control-Request-Headers")),s.res.headers.delete("Content-Length"),s.res.headers.delete("Content-Type"),new Response(null,{headers:s.res.headers,status:204,statusText:"No Content"})}await l(),r.origin!=="*"&&s.header("Vary","Origin",{append:!0})}};const Se=new gt;Se.use("/api/*",lr());Se.use("/static/*",cr({root:"./public"}));Se.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <style>
          ...
          * {
          ...
          .hero-bg {
            ...
            width: 100%;
            height: 120%;
            background-image: url('/static/images/hero-mobile.jpg');
          ...
          .hero-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(66, 35, 18, 0.75), rgba(42, 24, 16, 0.9));
    ...
    <body>
        ...
        <section id="home" class="hero-section">
            ...
            <div class="hero-content">
                <div>
                    <h1 class="hero-title texan-font">F&A CONSTRUCTION'S FINEST</h1>
  ...
  `));const Be=new gt,dr=Object.assign({"/src/index.tsx":Se});let xt=!1;for(const[,e]of Object.entries(dr))e&&(Be.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Be.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),xt=!0);if(!xt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{Be as default};
